...
- Edit the .json file with your HID/VID (you can get this from the VPC Configuration Tool) and desired bindings. Bit masks are available from flightdata.h in your ```[BMS dir]\Tools\SharedMem``` folder
